...
void mostrarTicket(const Ticket& ticket) {
    ...
    cout << ticket.logoEmpresa << endl;
    cout << ticket.datosEmpresa << endl;
    cout << "-----------------------------------" << endl;
    cout << "Productos "<< endl;
    double total = 0.0;
...
int main() {
    Ticket ticket;
    ticket.nombreEmpleado = "Juan Perez";
    ticket.logoEmpresa = "LOGO EMPRESA";
    ticket.datosEmpresa = "Direccion: Calle Falsa 123\nTelefono: 555-1234";
